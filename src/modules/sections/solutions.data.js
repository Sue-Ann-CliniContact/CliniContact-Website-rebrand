...
export const SOLUTIONS_PAGE = {
  ...
  sub: 'The same four modules, scoped differently. However you start, the shape holds: we plan the recruitment strategy around your study, run it alongside your team, and stay for the length of the trial. Most engagements begin with one pressure point and expand once the handoff is proven.',
  showJumps: true,
  sections: [
    {
      id: 'sites',
    ...
    },
    {
      ...
      desc: 'Running recruitment across multiple sites means outreach history fragments across coordinator inboxes and nobody can answer where a given participant actually is. Vision resolves inbound SMS and email against the right participant across every study, with role-scoped access so each site sees its own and the network sees all of it. One plan runs across every site, so recruitment scales without fragmenting into a dozen disconnected campaigns.',
      bullets: [
